...
impl Config {
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            age_key_dir: std::env::var("MAJNET_AGE_KEY_DIR").unwrap_or_else(|_| "/etc/majnet/age".into()).into(),
            docker_cert_dir: std::env::var("MAJNET_DOCKER_CERT_DIR").unwrap_or_else(|_| "/etc/majnet/pki".into()).into(),
